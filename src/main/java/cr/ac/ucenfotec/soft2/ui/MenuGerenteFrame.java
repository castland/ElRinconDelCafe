...
/**
 * Panel principal del Gerente con navegación lateral y accesos rápidos.
 *
...
public class MenuGerenteFrame extends javax.swing.JFrame {
    ...
    private void initUI() {
        setTitle("El Rincón del Café — Panel de Gerente");
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new BorderLayout());

        add(NavSidebar.build("Gerente", nombreUsuario, this::abrir, this::logout), BorderLayout.WEST);
    ...
    private JPanel buildContent() {
        ...
        JLabel s = UITheme.subtitle("Panel de administración · Rol Gerente");
        ...
        grid.add(quickCard("Inventario", "Gestione productos y stock", "Inventario"));
        ...
        grid.add(quickCard("Usuarios", "Gestione el personal del sistema", "Usuarios"));
        grid.add(quickCard("Reportes", "Genere reportes del negocio", "Reportes"));
    ...
    /** Navega a la pantalla indicada preservando el cableado original. */
    private void abrir(String destino) {
        ...
        switch (destino) {
            ...
            case "Usuarios" ->
                new AdministrarUsuariosFrame(this, gestorUsuarios).setVisible(true);
            case "Ventas" ->
